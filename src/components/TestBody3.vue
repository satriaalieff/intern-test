...
const checkAnswer = () => {
    ...
    if (jawabanSoal.value[0] === quizzes3[0].answer[2]) points += 10
    if (jawabanSoal.value[1] === quizzes3[1].answer[1]) points += 10
    if (jawabanSoal.value[2] === quizzes3[2].answer[1]) points += 10
    if (jawabanSoal.value[3] === quizzes3[3].answer[1]) points += 10
    if (jawabanSoal.value[4] === quizzes3[4].answer[1]) points += 10
    if (jawabanSoal.value[5] === quizzes3[5].answer[2]) points += 10
    if (jawabanSoal.value[6] === quizzes3[6].answer[1]) points += 10
    if (jawabanSoal.value[7] === quizzes3[7].answer[2]) points += 10
    if (jawabanSoal.value[8] === quizzes3[8].answer[0]) points += 10
    if (jawabanSoal.value[9] === quizzes3[9].answer[3]) points += 10
    if (jawabanSoal.value[10] === quizzes3[10].answer[1]) points += 10
    if (jawabanSoal.value[11] === quizzes3[11].answer[2]) points += 10
    if (jawabanSoal.value[12] === quizzes3[12].answer[3]) points += 10
    if (jawabanSoal.value[13] === quizzes3[13].answer[3]) points += 10
    if (jawabanSoal.value[14] === quizzes3[14].answer[2]) points += 10
    if (jawabanSoal.value[15] === quizzes3[15].answer[1]) points += 10
    if (jawabanSoal.value[16] === quizzes3[16].answer[1]) points += 10
    if (jawabanSoal.value[17] === quizzes3[17].answer[1]) points += 10
    if (jawabanSoal.value[18] === quizzes3[18].answer[1]) points += 10
    if (jawabanSoal.value[19] === quizzes3[19].answer[1]) points += 10
...
const submitAnswer = () => {
    ...
    if (!(candidate.level > 3)) candidate.level++
    router.push('/result')
}
</script>
...
<template>
    <form @submit.prevent="submitAnswer" class="container max-w-xl mx-auto px-4">
        ...
        <div v-for="(quiz, index) in quizzes3" v-show="index === nomorSoal - 1" :key="index"
